// ITU dial codes. A static constant, not an API call: dial codes change
// perhaps once a decade, and a phone field must never depend on a network
// round-trip to become usable.
